...
ip_group_dict = {}
file_cluster = f'./p0_cluster_result/period_{period_choose}/n_cluster_{argv[2]}_label_{argv[3]}.csv'
...
output_ip_index = f'./p1_capture_history/period_{period_choose}/ip_index.txt'
