...
def r_label_2_p2(n_cluster, label):
    ...
    time_len = int((end-start)/num_cluster)
...
streams = db.United_States.find({ "start": { "$lt": "2021-"+date[-1]+"T00:00:00"}, "end": { "$gte": "2021-"+date[0]+"T00:00:00"}})
...
file_cluster = f'./p0_cluster_result/n_cluster_{_num_cluster}/label_{_label}.csv'
