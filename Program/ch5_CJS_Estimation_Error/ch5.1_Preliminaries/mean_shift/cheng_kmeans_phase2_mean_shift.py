...
#sample_hour = ['12', '13']
#print(f'p2-sample_hour: {sample_hour}')
...
output_path = f'./p2_est_result_mean_shift_sample_hour_{sample_hour[0]}.txt'
...
plot_path = f'./p2_daily_plot_mean_shift_sample_hour_{sample_hour[0]}.png'
